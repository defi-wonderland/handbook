...
We’ll start with supply (scarcity and allocation), move to demand (utility, incentives, and culture), and then tie it together with valuation and emission schedules.
...
### Supply distribution and token allocation
...
### Return on investment (ROI) and yield mechanisms
...
- [Curve: CRV token supply distribution](https://resources.curve.fi/crv-token/supply-distribution/)
- [Nat Eliason: Tokenomics 101](https://crypto.nateliason.com/p/tokenomics-101)
- [Nat Eliason: Tokenomics 102 — Supply](https://crypto.nateliason.com/p/tokenomics-102-supply)
...
The status quo for message passing is unlikely to change, without some external shock. This could be triggered by events, such as the recent [KelpDAO and LayerZero incident](https://layerzero.network/blog/kelpdao-incident-statement), which might prompt incumbents to revisit their security assumptions. Or it could be driven by new entrants shaking up the market, as more assets and activity come onchain. In either case, the adoption of ERC-7786 will be determined by markets more than working groups.
